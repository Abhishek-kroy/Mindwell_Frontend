...
import {
  ...
  XCircle, Brain, Plus, AlertCircle
} from "lucide-react";
...
function MyChats() {
  ...
  const handleRequestSubmit = async (e) => {
    e.preventDefault();
    if (!requestReason.trim() || !college) return;
  ...
  return (
    <div className="flex bg-[#F9FBFF] pt-24 min-h-screen relative overflow-hidden">
      {/* Sidebar */}
      <aside className="w-full md:w-96 border-r border-gray-100 bg-white/70 backdrop-blur-2xl shadow-xl relative z-20 flex flex-col">
        {/* User Info & Toggle */}
              ...
              {!myRequest || myRequest.status === 'rejected' ? (
                ...
                <div className="p-4 bg-indigo-50/50 border border-indigo-100 rounded-2xl">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.1em] text-indigo-700">Support Status</span>
                  </div>
                  <p className="text-sm text-indigo-900 font-medium">
                    {myRequest.status === 'pending' ? 'Support request pending review...' : 'Active connection established.'}
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="space-y-2">
              {loading ? (
                ...
                <div className="py-20 text-center px-8">
                  ...
                  <p className="text-xs text-[#4A4E69]/40 leading-relaxed font-light">
                    ...
                    >
                      ...
                      <div className="flex-1 text-left min-w-0">
                        <div className="flex items-center justify-between mb-0.5">
                          ...
                          <span className="text-[9px] font-bold text-[#4A4E69]/30 uppercase tracking-tighter">
            ...
            <div className="space-y-3">
              {requests.length === 0 ? (
                <div className="py-20 text-center px-8">
                  ...
                  <p className="text-[10px] font-bold text-[#4A4E69]/40 uppercase tracking-[0.2em]">Queue Empty</p>
                </div>
              ) : (
                requests.map((req) => (
                  <div key={req.id} className="p-5 bg-white rounded-[2rem] border border-gray-50 shadow-sm space-y-4">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 font-bold text-sm">
                          {req.studentName?.charAt(0) || req.studentId?.charAt(0)}
                        </div>
                        <div>
      ...
      <section className="flex-1 relative z-10 flex flex-col h-[calc(100vh-96px)]">
        {selectedChat ? (
          <ChatRoom
            key={selectedChat.id}
